var express = require('express'),
	...
	randomColor = function(low, high) {
		return ['#',randomVal(low,high),randomVal(low,high),randomVal(low,high)].join('');
	},
	randomVal = function(low,high) {
		var n = Math.random()*high;
		if (n<low) {
			return randomVal(low,high);
		}
...
app.get('/', function(req,res) {
	...
	res.render('index', {dishName: dishName, textColor: randomColor(0,80), bgColor: randomColor(150, 255)} );
});
